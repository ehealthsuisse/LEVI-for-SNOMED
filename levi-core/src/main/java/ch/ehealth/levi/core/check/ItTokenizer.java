...
/**
 * Italian-aware text normalization and tokenization.
 *
 * <p>Applies Unicode NFC normalization, detects consecutive spaces, splits off
 * elision prefixes (l', un', d', dell', nell', sull', all', dall', quest', gl',
 * dov', ond') and hyphenated compounds.</p>
 */
public final class ItTokenizer {

    private static final Pattern WHITESPACE = Pattern.compile("\\s+");
    private static final Pattern MULTIPLE_SPACES = Pattern.compile("(?: {2,}|\\t)");
    private static final Pattern ELISION =
            Pattern.compile("^(?:l|un|d|dell|nell|sull|all|dall|quest|gl|dov|ond|cod|senz|tutt|quant|com)'",
